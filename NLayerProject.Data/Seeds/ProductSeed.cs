...
namespace NLayerProject.Data.Seeds
{
    class ProductSeed:IEntityTypeConfiguration<Product>
    {
        ...
        {
            builder.HasData(
                //ilk tablo olstuğu zaman içerisine data basıcaksak mutlaka idyi vermeliyiz.
                //decimal tuttuğumuz için tutar sonuna m harfi ekliyoruz.
                //Category id 0.index
